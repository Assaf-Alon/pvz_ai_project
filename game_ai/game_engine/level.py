...
class Level(object):
    ...
    def rollout(self, num_games=10000, mode=1, h=None):
        return _level.Level_rollout(self, num_games, mode, h)
...
def finish_playing_game(base_env, randomization_mode):
    return _level.finish_playing_game(base_env, randomization_mode)
