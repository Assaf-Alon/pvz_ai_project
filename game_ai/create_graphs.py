...
def plot_pvz_data_section_6_3(
    ...
    data_combined = pd.concat(
        [data_0, data_1, data_2, data_3, data_4], ignore_index=True
    )
...
def plot_pvz_data_all_improvements(
    ...
    data_6_3_4 = pd.concat(
        [data_6_3_4_0, data_6_3_4_1, data_6_3_4_2, data_6_3_4_3], ignore_index=True
    )
...
# )
# data_5_5_2_2_extra2["name_in_legend"] = (
#     "Parallel Trees Agent on Level 9++ with 300ms Limit"
# )
...
# data_5_5_2_2_extra = pd.concat(
#     [data_5_5_2_2_extra1, data_5_5_2_2_extra2, data_5_5_2_2_extra3], ignore_index=True
# )
...
plot_pvz_data_all_improvements(
    all_data, "9+", "6.3.4.1_all_improvements", "Comparing All Improvements on Level 9+"
)
plot_pvz_data_all_improvements(
    all_data,
    "9++",
